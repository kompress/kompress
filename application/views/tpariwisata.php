       ...
       <div class="container-fluid">
         <div class="row">
          ...
          <div class="container">
           <h4>Umum</h4>
           <ul class="unstyled">
              <li><a href="<?php echo base_url('navPariwisata') ?>">Pariwisata</a></li>
          ...
          <div class="container">
           ...
           <ul>
             ...
             <li><a href="<?php echo base_url('kritik_saran'); ?>">Kritik & Saran</a></li>
           </ul>
          </div>
          </div><!-- end col-sm-3 -->
         </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#provinsi_id").change(function (){
                var url = "<?php echo site_url('navPariwisata/add_kota');?>/"+$(this).val();
                $('#kabupaten').load(url);
                return false;
            })
        });

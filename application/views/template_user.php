      ...
      <a href="<?php echo base_url(); ?>" class="brand-logo white-text"><strong>Wisata Indonesia</strong></a>
        ...
        <ul id="nav-mobile" class="side-nav teal">
          ...
          <?php if($this->session->userdata('Login')=='berhasil' && $this->session->userdata('level')==0  && $this->session->userdata('active')==1){ ?>
            ...
            <li><a href="#" class="dropdown-button white-text" data-activates="dropdown2"><strong><?php if(!empty($pengguna->nama)){echo $pengguna->nama;} ?></strong><i class="material-icons right">arrow_drop_down</i></a></li>
           <?php } elseif($this->session->userdata('level')==1) { ?>
            <ul id="dropdown2" class="dropdown-content">
              <li><a href="<?php echo base_url('login/logout') ?>">Keluar</a></li>
              <li><a href="<?php echo base_url('home') ?>">Kembali ke Admin</a></li>
            ...
            <li><a href="#" class="dropdown-button white-text" data-activates="dropdown2"><strong><?php if(!empty($pengguna->nama)){echo $pengguna->nama;} ?></strong><i class="material-icons right">arrow_drop_down</i></a></li>
             <?php } else { ?>
                <li><a href="<?php echo base_url('login'); ?>" class="white-text"><strong>Masuk | Daftar</strong></a></li>
               <?php } ?>
        </ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col l2 s12">
          ...
          <ul>
            <li><a class="white-text" href="<?php echo base_url('contact');?>">Kontak</a></li>
            <li><a class="white-text" href="<?php echo base_url('kritik_saran'); ?>">Kritik & Saran</a></li>
          </ul>
        </div>
      </div>
    </div>

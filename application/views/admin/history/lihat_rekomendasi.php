    ...
    <div class="panel-body">
        <div class="col-md-offset-1 col-md-10">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-md-2 " >Latitude Lokasi</label>
                    <div class="col-sm-10">
                        <input type="hidden" name="id_lat" value="<?php echo $r->lat; ?>">
                        <input type="text" name="lat" class="form-control1" disabled="disabled" value="<?php echo $r->lat ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 " >Longitude Lokasi</label>
                    <div class="col-sm-10">
                        <input type="hidden" name="id_lng" value="<?php echo $r->lng; ?>">
                        <input type="text" name="lng" class="form-control1" disabled="disabled" value="<?php echo $r->lng ?>">
                    </div>
                </div>
                <div class="form-group">

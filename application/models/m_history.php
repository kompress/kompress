...
class M_history extends CI_Model {
    ...
    public function lihat_rekomendasi($id){
        ...
        $query =    "SELECT r.id_rekomendasi, r.nama_pariwisata, u.id_user, r.id_prov, r.id_kota, r.id_jenis_pariwisata, u.username, jp.nama_jenis, k.nm_kota, p.nm_prov, r.deskripsi, r.tanggal,r.nama_img,r.full_path,r.status,r.lat,r.lng
